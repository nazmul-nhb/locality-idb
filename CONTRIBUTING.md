...
Docs are built using the lightweight [Vocs](https://github.com/wevm/vocs#readme) framework (with [Waku](https://waku.gg)).
...
- Verifying behavior in the demo app: `pnpm run dev:demo` (or `pnpm run build:demo`)
...
# Generate CHANGELOG.md based on commit history
pnpm run changelog
```

> **Note:** These tools are optional but recommended for maintaining code quality.
...
2. Create a new branch for your feature or bug fix: `git checkout -b feat/my-feature`
