...
export const column = {
	 ...
	 */
	varchar: (l?: number) => new Column<string>(`varchar(${isPositive(l) ? l : '0'})`),
	/**
	 ...
	 */
	array: <T = any>() => new Column<Array<T>>(`array`),
	/**
	 ...
	 */
	list: <T = any>() => new Column<List<T>>(`list`),
	/**
	 ...
	 */
	tuple: <T = any>() => new Column<Tuple<T>>(`tuple`),
	/**
	 ...
	 */
	set: <T = any>() => new Column<Set<T>>(`set`),
	/**
	 ...
	 */
	map: <K = any, V = any>() => new Column<Map<K, V>>(`map`),
	/**
	 ...
	 */
	custom: <T = any>() => new Column<T>(`custom`),
} as const;
