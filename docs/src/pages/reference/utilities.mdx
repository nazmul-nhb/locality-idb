...
:::tip
  For generating different versions please use [`uuid()` from toolbox-x ](https://toolbox-x.vercel.app/docs/utils/hash/uuid)
:::
...
:::tip
  For more different formats please use [`getTimestamp()` from toolbox-x ](https://toolbox-x.vercel.app/docs/utils/date-time/get-timestamp)
:::
...
:::tip
  Imported from [toolbox-x ](https://toolbox-x.vercel.app/docs/guards/misc/string-format#isuuid)
:::
...
:::tip
  Imported from [toolbox-x ](https://toolbox-x.vercel.app/docs/guards/misc/string-format#isemail)
:::
...
:::tip
  Imported from [toolbox-x ](https://toolbox-x.vercel.app/docs/guards/misc/string-format#isurl)
:::
